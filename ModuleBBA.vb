Module ModuleBBA
    ...
    Public arr_leads() As String
    Public arr_leaders() As Integer
    Public arr_suits() As String
    ...
    Public Function get_BBA_HEX(ByVal str_hand As String) As String
        Dim i As Integer, j As Integer, k As Integer, encryption_byte As Integer, board_extension As Integer, number As Integer
        Dim str_card As String, str_Deal As String
        Dim blocks(3) As String
        Dim subblocks(3) As String
        '---coding BBA_HEX number
